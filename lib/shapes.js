...
class Shape {
  ...
  renderText() {
    return `<text x="150" y="125" font-size="68" text-anchor="middle" fill="${this.textColor}">${this.text}</text>`
  } 
  renderSVG(){
...
class Square extends Shape {
  ...
  render() {
    return `<rect x="62.5" y="12.5" width="175" height="175" fill="${this.shapeColor}"/>`;
  }
};
...
class Diamond extends Shape {
  ...
  render() {
    return `<rect x="62.5" y="12.5" width="175" height="175" transform="rotate(45, 100, 100)" fill="${this.shapeColor}"/>`;
  };
};
...
module.exports = { Shape, Circle, Square, Triangle, Diamond };